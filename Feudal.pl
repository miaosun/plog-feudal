...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%	         Funcao principal do inicio do jogo               %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	insere_todas_pecas(j1,Hand1,Tab,Tab1,_,_),!, clear(50),
	...
	humano_computador(j1,Tab2,_,Pos_PC),!);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%      1º fase do jogo, insercao de todas pecas dos jogadores       %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%funcao so serve no inicio do jogo,permite jogador inserir todas as pecas no tabuleiro Tab, e guarda último estado do tabuleiro no Tabf.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%	 Caminho de movimento de pecas entre origin e destino       %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%     Validacao dos movimentos segundo das regras de cada peca     %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Mode Humano vs Humano
humano_humano(J,Tab,Tabf,Lpos):-
	...
	write('Escolhe a posicao da Peca pretende mover'),nl,
	  ...
	  ((((J==j1, member(Casa,Pecas_J2)); (J==j2, member(Casa,Pecas_J1))),
	    ...
	    ((game_over(Tab2), print_tab(Tab2),mensagem_ganhar(J));
	     (mover_mais_pecas(J,Jf,Lpos2,Lpos3),humano_humano(Jf,Tab2,Tabf,Lpos3))));
	   (nl, write('Opcao invalida, tenta novamente!'),nl,sleep(1),clear(10),humano_humano(J,Tab,Tabf,Lpos)))
         );
	...
	(%quando escolher para movimentar, ou quando a peca nao foi Archer
	 ...
	 ((((J==j1, \+member(Casa,Pecas_J1));(J==j2, \+member(Casa,Pecas_J2))),%verifica se a posicao destino ?uma peca do jogador
	   ...
	   ((game_over(Tab2), mensagem_ganhar(J));
	    (mover_mais_pecas(J,Jf,Lpos2,Lpos3),humano_humano(Jf,Tab2,Tabf,Lpos3))));
	  (nl, write('Movimento nao valido, tenta novamente!'),nl,sleep(1),clear(10),humano_humano(J,Tab,Tabf,Lpos)))
	 ) ).
...
%Mode Jogador vs Computador
humano_computador(J,Tab,Tabf,Pos_PC):-
	(game_over(Tab), print_tab(Tab2),mensagem_ganhar(J));
	pecas_J1(Pecas_J1), pecas_J2(Pecas_J2),
	 ...
	 ((\+member(Casa,Pecas_J2),verifica_green(J,Casa,Tab), delete(Pos_PC,[Ln1,Cn1],Pos_PC_aux),
	   ...
	   ((game_over(Tab2),print_tab(Tab2),mensagem_ganhar(J));
	    (trocar_vez_pc(J,Jf),humano_computador(Jf,Tab2,Tabf,Pos_PC_f))) );
	  (nl,clear(10),humano_computador(J,Tab,Tabf,Pos_PC)) ) ) );         %operacao Computador
	 ...
	 ((\+member(Casa,Pecas_J1),verifica_green(J,Casa,Tab),jogada_valida(J,Peca,Ln1,Cn1,Ln2,Cn2,Tab),
	   ...
	   ((game_over(Tab2), print_tab(Tab2),mensagem_ganhar(J));
	    (trocar_vez_pc(J,Jf),humano_computador(Jf,Tab2,Tabf,Pos_PC))) );
	  (nl, write('Movimento nao valido, tenta novamente!'),nl,sleep(1),clear(10),humano_computador(J,Tab,Tabf,Pos_PC)) )
	 ) ).           %operacao Humano
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%	           Jogada da Peca especial Archer                  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%a peca especial Archer tem 2 possiveis jogadas, movimentar ou atacar
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                   Vizinhos de 4 direccoes de casas                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%imprime a visualizacao do jogo para jogador Computador
